...
class ChaufaLangostinosActivity : AppCompatActivity() {
    ...
    private val basePrice = 17.00 // Precio base del producto

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chaufa_langostinos)
    ...
    companion object {
        private const val PRODUCT_ID = "chaufa_langostinos"
    }
} 