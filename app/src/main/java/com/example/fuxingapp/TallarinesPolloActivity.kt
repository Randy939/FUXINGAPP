...
class TallarinesPolloActivity : AppCompatActivity() {
    ...
    private val basePrice = 15.00 // Precio base del producto

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tallarines_pollo)
    ...
    companion object {
        private const val PRODUCT_ID = "tallarines_pollo"
    }
} 